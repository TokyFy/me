            ...
            <div>
                ...
                <div className="grid grid-cols-4 gap-4">
                    <ul className="self-center border-r border-dotted border-neutral-400 pr-4">
                        <p className="bg-neutral-400 text-black w-fit px-1 my-1">{"< links >"}</p>
                ...
                <div className="grid grid-cols-4 gap-4 py-4">
                    <div className="flex flex-col border-r border-dotted border-neutral-400">
                        <p className="bg-neutral-400 text-black w-fit px-1 my-2">{"< hobbies >"}</p>
                    ...
                    <div className="col-span-3 ">
                        <h3 className="bg-neutral-400 text-black w-fit px-1 my-2">Comments</h3>
                        <table>
                            <tbody>
                                <tr>
                                    <td>{">>franaivo<<"}</td>
                ...
                <div className="col-span-3">
                        <h3 className="bg-neutral-400 text-black w-fit px-1 my-2">web status</h3>
                        <table>
                            <tbody>
                                <tr>
                                    <td>{">views : "}</td>
